# -*- coding: utf-8 -*-
"""
Created on Wed Apr  3 18:48:54 2019
...
# -*- coding: utf-8 -*-
"""
Created on Wed Apr  3 18:21:20 2019
...
df_d = pd.pivot_table(df[['revenue','start_time']],aggfunc='sum',index=df['start_time'].dt.date,columns=['revenue'],fill_value=0)  #date
...
with pd.ExcelWriter('outputY_Passholder.xlsx') as writer:  # doctest: +SKIP
